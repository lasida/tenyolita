                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item nav__item">
                            <a class="nav-link nav__link active" href="/">Beranda</a>
                        </li>
                        <li class="nav-item nav__item">
                            <a class="nav-link nav__link" href="/">Tentang kami</a>
                        </li>
                        <li class="nav-item nav__item">
                            <a class="nav-link nav__link" href="/">Pelayanan</a>
                        </li>
                        <li class="nav-item nav__item">
                            <a class="nav-link nav__link" href="portfolio.html">Portofolio</a>
                        </li>
                        <li class="nav-item nav__item">
                            <a class="nav-link nav__link" href="/">Karir</a>
                        </li>
                    </ul>
                </div>
    ...
    <main>
                ...
                <div class="hero row align-items-center">
                    <div class="col-md-6">
                        <div class="hero__caption">
                            <h1><strong>PT. SINTECH BERKAH ABADI</strong></h1>
                    ...
                    <div class="col-md-6">
                        <div class="hero__image">
                            <img src="assets/img/team.png" srcset="assets/img/team@2x.png" alt="team" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="goals row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="goal__image">
                            <img src="assets/img/goal.png" srcset="assets/img/goal@2x.png" alt="goal" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="goal__desc">
                ...
                <div class="advantage row">
                    <div class="col-md-6">
                        <div class="advantage__item">
                            <img
                                src="assets/img/advantages/1.png"
                                srcset="assets/img/advantages/1@2x.png"
                    ...
                    <div class="col-md-6">
                        <div class="advantage__item">
                            <img
                                src="assets/img/advantages/2.png"
                                srcset="assets/img/advantages/2@2x.png"
                                alt="respon cepat"
                            />
                            <h4>Respon Cepat</h4>
                            <p>
                    ...
                    <div class="col-md-6">
                        <div class="advantage__item">
                            <img
                                src="assets/img/advantages/3.png"
                                srcset="assets/img/advantages/3@2x.png"
                    ...
                    <div class="col-md-6">
                        <div class="advantage__item">
                            <img
                                src="assets/img/advantages/4.png"
                                srcset="assets/img/advantages/4@2x.png"
                ...
                <div class="team-wrapper">
                    <div class="team row g-4">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/1@2x.png"
                                    alt="yasin"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/2@2x.png"
                                    alt="eka rahmat"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/3@2x.png"
                                    alt="firmansyah"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/4@2x.png"
                                    alt="dandi"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/5@2x.png"
                                    alt="musthofa"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    ...
                                    srcset="assets/img/teams/6@2x.png"
                                    alt="arief"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    src="assets/img/teams/7.png"
                                    srcset="assets/img/teams/7@2x.png"
                                    alt="mradipto"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    src="assets/img/teams/8.png"
                                    srcset="assets/img/teams/8@2x.png"
                                    alt="jeffry"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    src="assets/img/teams/9.png"
                                    srcset="assets/img/teams/9@2x.png"
                                    alt="yunus"
                                />
                                <div class="desc">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-4">
                            <div class="team__item">
                                <img
                                    src="assets/img/teams/10.png"
                                    srcset="assets/img/teams/10@2x.png"
                                    alt="fathur"
                                />
                                <div class="desc">
        ...
        <section id="clients">
            <div class="container">
                ...
                <div class="client">
                    <img src="assets/img/clients.png" srcset="assets/img/clients@2x.png" alt="clients" />
                </div>
            </div>
        </section>
    </main>
